...
const Navbar = () => {
  ...
  const buttons = [
    { link: "mailto:born2runarun@gmail.com", icon: <Mail size={20} /> },
    { link: "https://github.com/athlative-arun", icon: <Github size={20} /> },
    { link: "https://www.linkedin.com/in/arunachalam-b-15a8a026", icon: <Linkedin size={20} /> },
  ];
