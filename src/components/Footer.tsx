      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <Mail size={18} />
                <a
                  href="mailto:born2runarun@gmail.com@gmail.com"
                  className="hover:text-indigo-600 dark:hover:text-indigo-400 transition"
                >
                  born2runarun@gmail.com
                </a>
              </div>
              {/* <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <Phone size={18} />
            ...
            <div className="flex gap-4 mt-6">
              {[
                {
                  href: "https://github.com/athlative-arun",
                  icon: <Github size={20} />,
                },
                {
                  href: "https://www.linkedin.com/in/arunachalam-b-15a8a0269",
                  icon: <Linkedin size={20} />,
                },
                {
                  href: "mailto:born2runarun@gmail.com",
                  icon: <Mail size={20} />,
                },
              ].map((social, index) => (
                <a
        ...
        <div className="border-t border-gray-300 dark:border-gray-800 mt-12 pt-8 text-sm text-gray-600 dark:text-gray-400 flex flex-col md:flex-row items-center justify-between gap-4 text-center">
          <div className="flex items-center justify-center gap-2 flex-wrap">
            <span>© {currentYear} Arunachalam B.</span>
